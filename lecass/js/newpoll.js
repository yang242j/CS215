function NewPollForm(event) {
    ...
    //close date (proper date format) c
    ...
    //question (non-blank; shorter than 100 characters) e
    ...
    //answers (up to five; either blank or shorter than 50 characters) i
    if (g.length > 50) {
    ...
    //answers (up to five; either blank or shorter than 50 characters) j
    if (h.length > 50) {
